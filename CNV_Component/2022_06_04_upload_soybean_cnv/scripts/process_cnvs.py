...
# python3 /data/yenc/projects/2022_03_24_mViz/2022_06_04_upload_cnv/scripts/process_cnvs.py \
# -i /data/yenc/projects/2022_03_24_mViz/2022_06_04_upload_cnv/data/cnvs.csv \
# -o /data/yenc/projects/2022_03_24_mViz/2022_06_04_upload_cnv/output/cnvs.txt
...
def process_line(line_array, output_array):
    accession = str(line_array[6]).strip()
